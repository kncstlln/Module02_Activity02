...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Module2_INotifyPropertyChanged.Android.dll" comes first in this list. */
		"Module2_INotifyPropertyChanged.Android.dll",
		"FormsViewGroup.dll",
		"Module2_INotifyPropertyChanged.dll",
